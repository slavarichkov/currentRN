...
function StatisticsCountersScreen({ navigation }) {
    ...
    return (
        <View style={[styles.container, backgroundColor]}>
            ...
            <FlatList
                data={records}
                renderItem={(item) => <ItemListReadings item={item.item} handleCkickRemove={handleCkickRemove} selectedTranslations={selectedTranslations} address={address} colorText={colorText} />}
